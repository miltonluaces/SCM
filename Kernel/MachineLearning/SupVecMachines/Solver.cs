...
namespace MachineLearning {
    ...
    internal class Solver   {
        ...
        private double get_C(int i)  {  return (y[i] > 0) ? Cp : Cn; }
    ...
    internal class Procedures  {
        ...
        #region Class decision_function
        ...
        // Interface functions
        //
        public static SVMModel svm_train(Problem prob, Parameter param)
        {
        ...
        public static void svm_predict_values(SVMModel model, Node[] x, double[] dec_values)
        {
        ...
        public static double svm_predict(SVMModel model, Node[] x)
        {
            if (model.Parameter.SvmType == SvmType.ONE_CLASS ||
               model.Parameter.SvmType == SvmType.EPSILON_SVR ||
               model.Parameter.SvmType == SvmType.NU_SVR)
        ...
        public static double svm_predict_probability(SVMModel model, Node[] x, double[] prob_estimates)
        {
